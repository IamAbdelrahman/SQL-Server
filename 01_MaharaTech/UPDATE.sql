/*
	1) Update the salary for the employee whose SSN is 102661 to be 1200.
	2) Update the salary for the employee and department number for the employee SSN is 102674
	to be 1700 in department 10
...
--1)
UPDATE Employee SET Salary = 1300 WHERE SSN = 102661

--2)
UPDATE Employee SET Salary = 1800, E_DNO = 11 WHERE SSN = 102674;